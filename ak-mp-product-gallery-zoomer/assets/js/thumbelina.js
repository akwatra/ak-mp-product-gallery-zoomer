...
;(function($) {
    $.fn.Thumbelina = function(settings) {
        ...
        $list.addClass('thumbelina').wrap('<div id="thumb_wrap" style="position:absolute;overflow:hidden;width:100%;height:100%;">');
        ...
        var animate = function() {
            ...
            //AK to fix scroll
            listDimension = listDimension + 20;
            $("#thumb_wrap").css("width",listDimension +"px"); 
            //AK to fix scroll
            ...
            if($(window).width() < 400){
					$(".cloudzoom").attr('data-cloudzoom','zoomPosition: "inside",autoInside: true,zoomSizeMode:"image",zoomOffsetX: 0,zoomFlyOut: false');
